...
class PersistedSettingsCache(SettingsCache):
    ...
    def _set_setting(self, setting_id, value_string):
        ...
        del kodi_addon
        from resources.lib.modules.settings_hot_cache import patch_hot_setting

        patch_hot_setting(setting_id, value_string if value_string != self.EMPTY_PERSISTED_SETTING_VALUE else "")
    ...
    def get_setting(self, setting_id, default_value=None):
        ...
        :rtype: str
        """
        from resources.lib.modules.settings_hot_cache import get_hot_setting

        hot_value = get_hot_setting(setting_id)
