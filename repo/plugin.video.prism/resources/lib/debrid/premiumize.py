...
from resources.lib.database.keys import get_client_id, get_client_secret
...
class Premiumize:
    ...
    def __init__(self):
        self.client_id = get_client_id("Premiumize") or ""
        self.client_secret = get_client_secret("Premiumize") or ""
        self.headers = {
    ...
    def auth(self):
        ...
        try:
            while poll_again and token_ttl > 0 and not progress.iscanceled():
                xbmc.sleep(1000)
    ...
    def is_service_enabled():
        """
        Check to confirm api is enabled in Prism
        :return:
        :rtype:
        """
